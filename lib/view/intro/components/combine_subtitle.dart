  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        const Responsive(
          desktop:
              AnimatedSubtitleText(start: 30, end: 40, text: 'Flutter & AI '),
          largeMobile:
              AnimatedSubtitleText(start: 30, end: 25, text: 'Flutter & AI '),
          mobile:
              AnimatedSubtitleText(start: 25, end: 20, text: 'Flutter & AI '),
          tablet:
              AnimatedSubtitleText(start: 40, end: 30, text: 'Flutter & AI '),
        ),
